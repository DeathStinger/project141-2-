...
function preload() {
 ...
 ping_paddle = loadSound("ball_touch_paddel.wav")
}
function setup(){
...
function draw(){
  if (wristX,wristY>0.2) {
    image(red_dot, wristX, wristY, 60, 60); 
  }
...
if(pcscore ==4){
    ...
    text("Press Restart button play again!",width/2,height/2+30)
    noLoop();
    pcscore = 0;
}
